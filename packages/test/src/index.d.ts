import type { Client, Request, Headers, Params } from '@mappersmith/core'
...
export * from './mocks/mock-utils'
export { MockAssert } from './mocks/mock-assert'
// ---------------------
// CHANGED IN V3: Now exporting the real class
