export declare const validKeys: (entry: Record<string, any>) => string[];
declare type Value = string | number | boolean;
export declare const buildRecursive: (key: string, value: Value | Value[] | Record<string, string>, suffix?: string) => string;
export declare const toQueryString: (entry: string | Record<string, string>) => string;
/**
 ...
 */
export declare const parseResponseHeaders: (headerStr: string) => Record<string, string>;
