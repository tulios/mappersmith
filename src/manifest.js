 ...
 *   @param {Function} obj.paramsEncodingOverride - default: encodeURIComponent
...
function Manifest(obj, { gatewayConfigs = null, middleware = [], context = {} }) {
  ...
  this.paramsEncodingOverride = obj.paramsEncodingOverride || encodeURIComponent
      ...
      assign(
        {
          ...
          paramsEncodingOverride: this.paramsEncodingOverride,
